...
export function ProjectItem() {
    return (
        <Button variant="ghost" className="flex flex-1 items-center justify-between shadow-sm gap-10 px-4 py-2">
            <div className="flex flex-1 flex-col justfiy-center items-start gap-1">
                ...
                <Field className="w-full max-w-sm">
                    ...
                    <Progress value={66} id="progress-upload" className="bg-background" />
                </Field>
            </div>
