                ...
                <div className="flex justify-center items-center gap-5">
                    <div className="flex items-start justify-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-medium"><span className="text-muted-foreground mr-1">USD</span>{formatCurrency(capital)} M</p>
                        </div>
                    ...
                    <div className="flex items-start justify-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-medium"><span className="text-muted-foreground mr-1">USD</span>{formatCurrency(nonCapital)} M</p>
                        </div>
